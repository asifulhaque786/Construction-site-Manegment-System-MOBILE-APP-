...
final usernamecontroller1234188 = new TextEditingController();
...
void getcurrentperson() async {
  try {
    ...
    FirebaseDatabase.instance
      ...
      lol777 = values['datad']['data7']["other"];

      me = values['name'];

      usernamecontroller1234188.text = lol777.toString();
...
class other extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _otherState();
}
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                      ...
                                      controller: usernamecontroller1234188,
                                      autocorrect: true,
                          ...
                          Container(
                              ...
                              child: RaisedButton(
                                ...
                                child: Text("SUBMIT",
                                    style: TextStyle(fontSize: 17)),
                                onPressed: () async {
                                  if (usernamecontroller1234188.text == "") {
                                    Fluttertoast.showToast(
                                        msg: "FEILDS MISSING",
                                        backgroundColor: Colors.red,
                                        textColor: Colors.white);
                                    ...
                                    FirebaseDatabase.instance
                                        ...
                                        .child("data7")
                                        .set({
                                      'other': usernamecontroller1234188.text,
                                      'set': '1',
                                    }).then(
                                      (value) => {
                                        {

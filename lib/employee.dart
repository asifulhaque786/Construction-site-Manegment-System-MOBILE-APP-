...
final usernamecontroller1231 = new TextEditingController();
final passwordcontroller21 = new TextEditingController();
var userget = false;
var emailId = "";
var loggedInperson;
var me = "";
...
void getcurrentperson() async {
  try {
    ...
    FirebaseDatabase.instance
      ...
      lol = values['datad']['data2']["male"];
      last = values['datad']['data2']["female"];
      me = values['name'];

      usernamecontroller1231.text = lol.toString();
      passwordcontroller21.text = last.toString();
    });
    ;
  } catch (e) {
    print(e);
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                      ...
                                      controller: usernamecontroller1231,
                                      autocorrect: true,
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                      keyboardType: TextInputType.number,
                                      controller: passwordcontroller21,
                                      autocorrect: true,
                                      cursorColor: Colors.black,
                                      enableSuggestions: true,
                                      decoration: InputDecoration(
                          ...
                          Container(
                              ...
                              child: RaisedButton(
                                ...
                                child: Text("SUBMIT",
                                    style: TextStyle(fontSize: 17)),
                                onPressed: () async {
                                  if (usernamecontroller1231.text == "" ||
                                      passwordcontroller21.text == "") {Fluttertoast.showToast(
                                      msg: "FEILDS EMPTY",
                                      backgroundColor: Colors.red,
                                      textColor: Colors.white);
                                  } else {
                                    ...
                                    FirebaseDatabase.instance
                                        ...
                                        .child("data2")
                                        .set({
                                      'male': usernamecontroller1231.text,
                                      'female': passwordcontroller21.text,                                      'set':'1',
